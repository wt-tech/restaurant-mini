...
Page({
    ...
    onLoad : function(){
        ...
        if (this.data.reserveInfo.reservationsMode === constant.bookBoxAndOrder)
            this.initMenus();
    },
    ...
    initReserveInfo : function(){
        let params = getApp().assembleBoxReservInfo();
        this.setData({
            reserveInfo: params
        });
    },
    reserveSubmit: function () {
        ...
        httpReq.postRequestWithJSONSchema(['reserve/savereserve', params]).then(function (success) {
